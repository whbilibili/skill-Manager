...
metadata:
  version: "1.0.0"
  author: "wanghong52"
  changelog: "v1.0.0 — 初始版本，融合 backend-architect v2.1.0 和 frontend-architect v2.1.0，新增全栈技术栈支持（Next.js 全栈、BaaS、Convex 等）"
---
...
13. `docs/DESIGN.md` — 设计语言约定（有 UI 层时生成，对接 ARCHITECTURE.md 设计系统区块）
